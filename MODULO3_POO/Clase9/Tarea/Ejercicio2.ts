...
type PedidoFlor = [string, number, string] // Nombre cliente, cantidad de flores y tipo de flores

const pedidos: PedidoFlor[] = [];

// Funcion parta añadir nuevas clientes con sus respectivas flores
function agregarPedido(nombreCliente: string, cantidadFlores: number, tipoFlores: string) {
    const nuevoPedido: PedidoFlor = [nombreCliente, cantidadFlores, tipoFlores];
