...
function agregarCuenta(nombrePropietario, saldo, activa) {
    const nuevaCuenta = [nombrePropietario, saldo, activa];
...
function realizarTransferencia(indiceOrigen, indiceDestino, cantidad) {
    setTimeout(() => {
