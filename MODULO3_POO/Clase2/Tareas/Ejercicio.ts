...
function deporte(deportista: {nombre: string, deporte: string, energia: number}, horas: number): void {
...
export
const resultado = sumarTodos(10, 15, 5, 17)
console.log("La suma total de los numeros ingresados es: ", resultado)
...
function calcularArea(tipo: string, ...parametreos: number[]): number {
    if (tipo === "circulo") {
